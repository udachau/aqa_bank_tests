...
class TestAccountTransfer:
    def test_account_transfer(self):
        create_user1_request = CreateUserRequest(username="MaxFrom2", password="Pas!sw0rd", role="ROLE_USER")
        create_user2_request = CreateUserRequest(username="MaxTo2", password="Pas!sw0rd", role="ROLE_USER")
        ...
        resp_creation_balance = CreateAccountRequester(
            request_spec=RequestSpecs.auth_headers(username="MaxFrom2", password="Pas!sw0rd"),
        ...
        resp_creation_balance = CreateAccountRequester(
            request_spec=RequestSpecs.auth_headers(username="MaxTo2", password="Pas!sw0rd"),
            response_spec=ResponseSpecs.request_created()
        ).post()
