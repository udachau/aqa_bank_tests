...
@pytest.fixture
def transfer_account_request(api_manager, create_user_request, deposit_account_request):
...
@pytest.fixture
def credit_account_request(api_manager, create_credituser_request):
...
@pytest.fixture
def repay_account_request(api_manager, create_credituser_request, credit_account_request):
